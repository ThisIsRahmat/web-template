...
import css from './LinkTextInput.module.css';

const CONTENT_MAX_LENGTH = 5000;

const LinkTextInputComponent = props => {
  const {
    rootClassName,
    className,
    inputRootClass,
  ...
  const LinkMeta = { touched: hasError, error: errorText };
...
LinkTextInputComponent.defaultProps = {
  rootClassName: null,
  className: null,
  inputRootClass: null,
  onUnmount: null,
...
LinkTextInputComponent.propTypes = {
...
class LinkTextInput extends Component {
  ...
  render() {
    return <Field component={LinkTextInputComponent} {...this.props} />;
  }
}
